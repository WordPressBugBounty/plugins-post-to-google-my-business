...
* Improved: Handling of large AVIF/WebP files that could exceed 5MB when converted to PNG for GBP
* Improved: Added offending image URL in image error messages
