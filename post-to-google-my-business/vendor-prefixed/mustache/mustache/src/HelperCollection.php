...
use PGMB\Vendor\Mustache\Exception\UnknownHelperException;
/**
...
class HelperCollection
{
     ...
     * Magic mutator.
     *
     * @see \PGMB\Vendor\Mustache\HelperCollection::add
     *
     * @param string $name
     * @param mixed  $helper
     */
     ...
     * Magic accessor.
     *
     * @see \PGMB\Vendor\Mustache\HelperCollection::get
     *
     * @param string $name
     *
     * @return mixed Helper
     ...
     * Magic isset().
     *
     * @see \PGMB\Vendor\Mustache\HelperCollection::has
     *
     * @param string $name
     *
     ...
     * Magic unset().
     *
     * @see \PGMB\Vendor\Mustache\HelperCollection::remove
     *
     * @param string $name
     */
