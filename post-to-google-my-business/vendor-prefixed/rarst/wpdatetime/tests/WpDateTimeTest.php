...
/**
 * @coversDefaultClass \PGMB\Vendor\Rarst\WordPress\DateTime\WpDateTimeTrait
 */
class WpDateTimeTest extends WpDateTimeTestCase
{
    ...
    public function testFormatI18n()
    {
        ...
        $this->assertEquals($wp_datetime->setTimezone(new \DateTimeZone($offset))->format(DATE_W3C), $wp_datetime->setTimezone(new \DateTimeZone($offset))->formatI18n(DATE_W3C));
        $date_format = 'F j, Y';
